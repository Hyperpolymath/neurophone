...
:experimental:
:url-github: https://github.com/hyperpolymath/neurophone
:url-gitlab: https://gitlab.com/hyperpolymath/neurophone
:url-bitbucket: https://bitbucket.org/hyperpolymath/neurophone
:url-codeberg: https://codeberg.org/hyperpolymath/neurophone
...
neurophone is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
